#include <cmath>
#include "LiveRobotCompetitionSystem.h"
...
list<Task> BaseSystem::move(vector<Action>& actions)
{
    ...
    // TODO: Refactor this from the curr_states to the goal_poses after 1 time step
...
void BaseSystem::simulate(int simulation_time)
{
    ...
    for (; timestep < simulation_time; )
    {
        ...
        // TODO: Get the current poses from the Executor
