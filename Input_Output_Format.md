...
| taskRelease     | List <br />A list of the release time of each task. Each item in list contains a list [task_id, timestep] represents the task id and the reveal time. |
